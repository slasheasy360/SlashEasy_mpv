...
const SOCIALS = [
  {
    name: "Instagram",
    href: "https://www.instagram.com/theslasheasy/",
    icon: (
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/company/slasheasy/posts/?feedView=all",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
    ...
    <footer className="bg-[#07071a] dark:bg-surface-dark text-white border-t border-white/[0.04]">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="py-16 grid md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          {Object.entries(FOOTER_LINKS).map(([heading, links]) => (
            <div key={heading}>
              ...
              <ul className="space-y-3">
                {links.map((link) => (
                  <li key={link.label}>
                    <a href={link.href} className="text-sm text-white/35 hover:text-white/70 transition-colors duration-200">
                      {link.label}
                    </a>
                  </li>
                ))}
          ...
          {/* Contact Us */}
          <div>
            <h4 className="font-semibold text-sm text-white/80 mb-4">Contact Us</h4>
            <address className="not-italic text-sm text-white/35 leading-relaxed space-y-3">
              <p>
                7th, G/701, Agrawal Apartment,<br />
                100 Main Road, OPP Anand Nagar,<br />
                Satellite, Ahmedabad–380015,<br />
                Gujarat, India
              </p>
              <p>
                <a
                  href="mailto:info@slasheasy.com"
